...
(1) Find the square root of the number, then round it up.
...
if prime:
    print(f"∴ {num} is a prime number, it's not divisible by any of the prime numbers from 2 to {num_root}.")
else:
